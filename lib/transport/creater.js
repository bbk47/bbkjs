...
exports.createTransport = function(tunnelOpts, onOpen) {
    if (tunnelOpts.protocol === 'ws') {
        return exports.createWebsocketTransport(tunnelOpts, onOpen);
    } else if (tunnelOpts.protocol === 'h2') {
        return exports.createHttp2Transport(tunnelOpts, onOpen);
    } else if (tunnelOpts.protocol === 'tls') {
        return exports.createTlsTransport(tunnelOpts, onOpen);
    } else if (tunnelOpts.protocol === 'tcp') {
        return exports.createTcpTransport(tunnelOpts, onOpen);
    } else {
